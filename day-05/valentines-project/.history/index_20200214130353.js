...
const promptPlayers = inquirer.createPromptModule()
...
function ValentinesContest(contestant, numContestants, contestantNames, favBand, outside, houseCondition) {
...
const dog = new ValentinesContest(true, false, true, 12, false, 100)
const dog = new ValentinesContest(false, true, false, 9, true, 100)
