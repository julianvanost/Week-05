...
function Valentines(contestant, numContestants, contestantNames, favBand, outside, houseCondition) {
...
const dog = new Valentines(true, false, true, 12, false, 100)
const dog = new Valentines(false, true, false, 9, true, 100)
