...
function Charact(name, nonGMO, kosher, keto) {
...
function Product(name, nonGMO, kosher, keto, name, category, quantity, price) {
...
function Food(name, nonGMO, kosher, keto, name, category, quantity, price, calories, fat, carbs, protein) {
